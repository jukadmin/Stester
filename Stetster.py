...
if opti == True:
    ...
    stats = bt.optimize( adx_min=range(20, 28, 2),  bb_length=range(12, 16, 2),
                         lookback_bars=range(16, 22, 2), stop_loss_pct=range(4, 8, 1),
                        ...
                        # trail_step_pct=range(1, 2, 1),   adx_period=range(10, 16, 2),
